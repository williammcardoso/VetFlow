...
import { FaArrowLeft, FaMoneyBillWave, FaArrowUp, FaArrowDown, FaChartLine, FaWallet, FaTag, FaCalendarAlt, FaPaw } from "react-icons/fa";
...
// Reuso das páginas já existentes
import BudgetsPage from "./sales/BudgetsPage";
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="flex-1 p-6">
        <Tabs defaultValue="orcamentos" className="w-full">
          ...
          {/* Aba Lançamentos (Resumo + Lançamentos Recentes) */}
                      ...
                      <Card key={transaction.id} className="p-4 bg-card shadow-sm border border-border">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-muted-foreground">
                          ...
                          {transaction.relatedAnimalId && (
                            <div className="flex items-center gap-1">
                              <FaPaw className="h-3 w-3" /> Animal:{" "}
