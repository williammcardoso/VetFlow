# Biblioteca de Documentos Médico-Veterinários — VetFlow

**Versão 1.0 — Agosto/2026**
Modelos prontos para cadastro no módulo de Documentos do VetFlow, com variáveis de mesclagem (`{{ }}`) e fundamentação legal.

---

## 1. Base normativa consolidada

| Norma | O que trata |
|---|---|
| **Lei nº 5.517/1968** e **Decreto nº 64.704/1969** | Exercício da profissão de médico-veterinário; atos privativos |
| **Resolução CFMV nº 1.138/2016** | Código de Ética do Médico-Veterinário |
| **Resolução CFMV nº 1.321/2020** | **Norma central**: institui os documentos obrigatórios da clínica médico-veterinária, conteúdo mínimo, número de vias e modelos |
| **Resolução CFMV nº 1.653/2025** | Altera a 1.321/2020: amplia conteúdo do prontuário, prazos de entrega de cópia, termo de retirada sem alta em qualquer situação, substitui "proprietário" por **"responsável pelo animal"**, redefine microchip |
| **Resolução CFMV nº 1.000/2012** | Procedimentos e métodos de eutanásia; métodos aceitáveis, sob restrição e inaceitáveis (Anexo I) |
| **Guia Brasileiro de Boas Práticas para a Eutanásia em Animais (CFMV, 2013)** | Complemento técnico da Res. 1.000/2012 |
| **Resolução CFMV nº 1.236/2018** | Define e caracteriza crueldade, abuso e maus-tratos contra animais vertebrados |
| **Resolução CFMV nº 670/2000** | Estabelecimentos médico-veterinários e responsabilidade técnica |
| **Lei nº 9.605/1998, art. 32**, com redação da **Lei nº 14.064/2020 (Lei Sansão)** | Crime de maus-tratos; pena qualificada para cães e gatos |
| **Código Civil (Lei nº 10.406/2002)** | Arts. 82 (animais como bens semoventes), 186 e 927 (responsabilidade civil), 951 (responsabilidade do profissional de saúde), 206 §3º V (prescrição) |
| **CDC (Lei nº 8.078/1990)** | Arts. 6º, III (direito à informação clara e adequada), 14 (responsabilidade do fornecedor de serviços), 27 (prescrição em 5 anos), 39 e 51 (práticas e cláusulas abusivas) |
| **LGPD (Lei nº 13.709/2018)** | Tratamento dos dados pessoais do responsável pelo animal |

### Princípio jurídico que sustenta todos os termos

A obrigação do médico-veterinário clínico/cirurgião é, em regra, **obrigação de meio** — comprometimento com a técnica correta e a diligência, não com o resultado. O **consentimento livre e esclarecido documentado** é o principal instrumento que comprova o cumprimento do dever de informação (CDC art. 6º, III) e delimita a expectativa do responsável. Sem ele, a jurisprudência tende a inverter o ônus da prova contra o profissional.

> ⚠️ **Cirurgia estética e alguns procedimentos eletivos** podem ser lidos como obrigação de resultado. Nesses casos, o termo deve ser ainda mais detalhado quanto a limitações e possibilidades de resultado.

---

## 2. Regras gerais de emissão (implementar como validação no VetFlow)

1. **Duas vias** (físicas e/ou digitais) para todos os documentos — uma entregue ao responsável, outra arquivada. **Exceções:** atestado sanitário, prontuário e carteira de vacinação.
2. Todo documento emitido **compõe o prontuário** do paciente.
3. **Sem rasuras ou emendas.** No sistema: documento emitido deve ser imutável; correção só por reemissão com registro de motivo.
4. **Dados obrigatórios em todo documento:** nome completo e assinatura do médico-veterinário, nº de inscrição no CRMV, endereço, telefone, e-mail e, quando aplicável, identificação do estabelecimento (razão social, CNPJ, registro no CRMV).
5. **Consentimento sempre prévio** ao procedimento. Exceção: iminente risco de morte ou incapacidade permanente — atende-se primeiro e registra-se tudo em prontuário.
6. **Recusa de assinatura:** registrar em prontuário + colher assinatura de **duas testemunhas** presentes ao fato.
7. **Documento eletrônico** deve ter sistema que garanta segurança, autenticidade, confidencialidade, integridade, armazenamento e compartilhamento. → No VetFlow: hash SHA-256 do PDF, carimbo de tempo, log de emissão e, idealmente, assinatura ICP-Brasil ou aceite com IP + geolocalização + timestamp.
8. **Cópia de prontuário:** apenas ao responsável pelo animal, em até **5 dias úteis**, prorrogável mediante justificativa por escrito (até 30 dias).
9. **Nomenclatura:** usar **"responsável pelo animal"** (padronização da Res. 1.653/2025). "Tutor" pode aparecer entre parênteses na interface.
10. **Guarda recomendada:** mínimo de 5 anos após o último atendimento (prazo do CDC art. 27), preferencialmente 10 anos.
11. **Vedada propaganda ou publicidade** de produtos/serviços nos documentos, inclusive os próprios.

---

## 3. Variáveis de mesclagem padrão (schema para o VetFlow)

```
── ESTABELECIMENTO ──────────────────────────
{{estab.razao_social}}      {{estab.nome_fantasia}}
{{estab.cnpj}}              {{estab.crmv_pj}}
{{estab.endereco}}          {{estab.cidade}}   {{estab.uf}}
{{estab.telefone}}          {{estab.email}}
{{estab.logo_url}}

── MÉDICO-VETERINÁRIO ───────────────────────
{{vet.nome}}                {{vet.crmv}}       {{vet.crmv_uf}}
{{vet.cpf}}                 {{vet.especialidade}}
{{vet.endereco}}            {{vet.telefone}}   {{vet.email}}
{{vet.assinatura_url}}

── RESPONSÁVEL PELO ANIMAL ──────────────────
{{resp.nome}}               {{resp.cpf}}       {{resp.rg}}
{{resp.endereco}}           {{resp.cidade}}    {{resp.uf}}   {{resp.cep}}
{{resp.telefone}}           {{resp.email}}

── PACIENTE ─────────────────────────────────
{{pac.nome}}                {{pac.especie}}    {{pac.raca}}
{{pac.sexo}}                {{pac.castrado}}
{{pac.idade}}               {{pac.data_nascimento}}
{{pac.pelagem}}             {{pac.peso}}
{{pac.microchip}}           {{pac.resenha}}

── ATENDIMENTO ──────────────────────────────
{{atend.numero}}            {{atend.data}}     {{atend.hora}}
{{atend.hora_entrada}}      {{atend.hora_saida}}
{{atend.diagnostico}}       {{atend.diagnostico_presuntivo}}
{{atend.prognostico}}       {{atend.procedimento}}
{{atend.medicamentos}}      {{atend.observacoes}}
...
## 4. Cabeçalho e rodapé padrão (aplicar a todos os modelos)

**CABEÇALHO**
```
[{{estab.logo_url}}]

{{estab.razao_social}} — CNPJ {{estab.cnpj}} — CRMV-{{estab.uf}} PJ nº {{estab.crmv_pj}}
{{estab.endereco}} — {{estab.cidade}}/{{estab.uf}} — Tel.: {{estab.telefone}} — {{estab.email}}

Médico-Veterinário Responsável: {{vet.nome}} — CRMV-{{vet.crmv_uf}} nº {{vet.crmv}}
```

**RODAPÉ**
```
Documento nº {{doc.numero}} — emitido em 2 (duas) vias, nos termos do art. 3º, I,
da Resolução CFMV nº 1.321/2020 (alterada pela Resolução CFMV nº 1.653/2025).
Validação: {{doc.qr_validacao}} — Código: {{doc.hash}}
```

**BLOCO DE IDENTIFICAÇÃO DO PACIENTE** (reutilizável em todos os termos)
```
IDENTIFICAÇÃO DO PACIENTE
Nome: {{pac.nome}}          Espécie: {{pac.especie}}       Raça: {{pac.raca}}
Sexo: {{pac.sexo}}          Idade: {{pac.idade}}           Peso: {{pac.peso}} kg
Pelagem: {{pac.pelagem}}    Microchip: {{pac.microchip}}
Resenha/sinais particulares: {{pac.resenha}}

IDENTIFICAÇÃO DO RESPONSÁVEL PELO ANIMAL
Nome: {{resp.nome}}         CPF: {{resp.cpf}}     RG: {{resp.rg}}
Endereço: {{resp.endereco}} — {{resp.cidade}}/{{resp.uf}} — CEP {{resp.cep}}
Telefone: {{resp.telefone}} E-mail: {{resp.email}}
```
...
{{resp.nome}}                              {{vet.nome}}
CPF {{resp.cpf}}                           CRMV-{{vet.crmv_uf}} nº {{vet.crmv}}
Responsável pelo animal                    Médico-Veterinário
```

---

# GRUPO A — ATESTADOS E DECLARAÇÕES

---

## A1. Atestado de Comparecimento do Responsável

> **Base legal:** art. 4º, §2º da Res. CFMV nº 1.321/2020 (o profissional pode emitir outros documentos que julgar necessários). Não é atestado médico de pessoa — apenas certifica a permanência do responsável no estabelecimento. **Nunca** declare condição de saúde humana nem justifique afastamento laboral; o documento apenas comprova o fato do comparecimento, cabendo ao empregador aceitá-lo ou não.
...
[BLOCO DE ASSINATURA DO MÉDICO-VETERINÁRIO]
```
...
> **Base legal:** art. 2º, I, Res. CFMV nº 1.321/2020. Documento **privativo** do médico-veterinário. Não pode conter rasuras ou emendas.
...
> **Base legal:** art. 2º, III, Res. CFMV nº 1.321/2020. **Exceção à regra das duas vias** — emitido em via única. Deve refletir apenas o que foi efetivamente constatado no exame.
...
> **Base legal:** art. 2º, II, Res. CFMV nº 1.321/2020. A carteira de vacinação é exceção à regra das duas vias. **A assinatura só pode ser aposta após a efetiva aplicação** — é vedado assinar carteira em branco ou dar continuidade a carteira que não atenda aos requisitos normativos.
...
```
RELATÓRIO MÉDICO-VETERINÁRIO E ENCAMINHAMENTO
...
> **Base legal:** art. 4º, §2º, Res. CFMV nº 1.321/2020. A requisição de exame é ato privativo do médico-veterinário (Lei nº 5.517/1968). Deve conter dados suficientes para que o colega executor conduza o exame com a técnica adequada — requisição vaga gera exame inconclusivo.

```
SOLICITAÇÃO DE EXAME DE IMAGEM
...
**Nota de implementação:** o campo `{{exame.requisitos}}` e `{{exame.objetivos}}` devem ser **arrays**. Filtrar itens vazios antes de renderizar — listas com marcadores em branco ou itens numerados sem conteúdo depõem contra o documento.
...
```
SOLICITAÇÃO DE EXAME LABORATORIAL / ANATOMOPATOLÓGICO
...
# GRUPO B — TERMOS DE CONSENTIMENTO LIVRE E ESCLARECIDO (TCLE)

> Os dez termos abaixo derivam do art. 4º da Res. CFMV nº 1.321/2020. Os incisos I a X preveem: exames; procedimento terapêutico de risco; procedimento cirúrgico; retirada de corpo de animal em óbito; internação e tratamento clínico ou pós-cirúrgico; procedimentos anestésicos; eutanásia; retirada sem alta médica; doação de corpo para ensino e pesquisa; e pesquisa clínica.

---

## B1. TCLE — Realização de Exames

> **Base legal:** art. 4º, I, Res. CFMV nº 1.321/2020. Quando o exame oferecer riscos, é obrigatório informar o grau de comprometimento e a possibilidade de debilidade de sentido ou função.
...
> **Base legal:** art. 4º, III, Res. CFMV nº 1.321/2020. Modelo especialmente relevante para cirurgia de tecidos moles.
...
### B2-C. Variante consolidada: TCLE de Procedimento Anestésico e Cirúrgico

> **Quando usar:** cirurgias eletivas de rotina (castração, nodulectomia, profilaxia dentária), em que apresentar dois documentos separados é operacionalmente ineficiente.
>
> **Como construir:** a Res. CFMV nº 1.321/2020 lista cirurgia (art. 4º, III) e anestesia (art. 4º, VI) como termos distintos, mas o que a norma fixa é o **conteúdo mínimo** de cada um. Um documento único intitulado *"Termo de Consentimento Livre e Esclarecido de Procedimento Anestésico e Cirúrgico"* é admissível **desde que contenha integralmente o conteúdo dos dois termos**.
>
> **Montagem no VetFlow:** título consolidado + seções 1 a 5 do B2 + seções 2 a 6 do B3 inseridas como bloco "PARTE ANESTÉSICA" + seções 6 a 15 do B2. Registrar no `payload_json` que o documento satisfaz os dois incisos, para fins de auditoria.
>
> ⚠️ **Não usar a variante consolidada em:** cirurgias de alto risco, pacientes ASA III ou superior, procedimentos de urgência com instabilidade hemodinâmica, ou quando o anestesista for profissional distinto do cirurgião. Nesses casos, emitir B2 e B3 separadamente, cada um assinado pelo respectivo responsável técnico.

---

## B3. TCLE — Procedimentos Anestésicos

> **Base legal:** art. 4º, VI, Res. CFMV nº 1.321/2020.
...
> **Base legal:** art. 4º, II, Res. CFMV nº 1.321/2020. Usar para quimioterapia, transfusão, hemodiálise, imunoterapia, uso off-label, terapias experimentais.
...
> **Base legal:** art. 4º, V, Res. CFMV nº 1.321/2020.
...
> **Base legal:** art. 4º, IV, Res. CFMV nº 1.321/2020. A norma exige que, ao entregar o corpo, seja indicada a **responsabilidade do responsável pelo descarte ambientalmente adequado**.

```
TERMO DE CONSENTIMENTO LIVRE E ESCLARECIDO E RESPONSABILIDADE
...
> **Base legal:** art. 4º, IX, Res. CFMV nº 1.321/2020.
...
> **Base legal:** art. 11 da Res. CFMV nº 1.321/2020, com redação da Res. CFMV nº 1.653/2025. **Mudança importante:** agora é exigido em **qualquer** retirada sem alta, e não apenas em risco iminente de morte. Havendo recusa de assinatura, registrar em prontuário e colher **duas testemunhas** que presenciaram a recusa.
...
> **Base legal:** art. 4º, X, Res. CFMV nº 1.321/2020, c/c Resolução Normativa CONCEA nº 22/2015. Exige aprovação prévia por CEUA.
...
# GRUPO C — TERMOS DE RECUSA / NÃO ACEITE

> **Base legal:** art. 4º, §2º (o profissional pode emitir outros termos que julgar necessários) e art. 10, II, da Res. CFMV nº 1.321/2020 (dever de registrar em prontuário toda recusa de consentimento ou autorização). Estes são os documentos que mais protegem o profissional na prática diária.
...
```
TERMO DE CIÊNCIA E RECUSA DE TRATAMENTO
...
```
TERMO DE CIÊNCIA E RECUSA DE EXAMES COMPLEMENTARES
...
```
TERMO DE CIÊNCIA E RECUSA DE INTERNAÇÃO
...
> Use quando a eutanásia é tecnicamente indicada (art. 3º, I, Res. 1.000/2012) e o responsável recusa. Documento essencial: protege o profissional e cumpre o dever ético de advertir sobre maus-tratos por omissão.

```
TERMO DE CIÊNCIA E RECUSA DE EUTANÁSIA INDICADA
...
> Modelo autônomo para quando o responsável se recusa a assinar qualquer termo. Vincular ao prontuário.

```
REGISTRO DE RECUSA DE ASSINATURA DE DOCUMENTO
...
# GRUPO D — TERMOS COMPLEMENTARES E ADMINISTRATIVOS
...
```
TERMO DE CIÊNCIA DE PROGNÓSTICO E PLANO DE CUIDADOS PALIATIVOS
...
> **Base legal:** CDC arts. 6º, III e 40 (orçamento prévio). Validade padrão de 10 dias, salvo estipulação diversa.

```
ORÇAMENTO DE SERVIÇOS MÉDICO-VETERINÁRIOS
...
> **Base legal:** Código Civil art. 20; LGPD (Lei nº 13.709/2018), arts. 7º, I e 8º. Atenção: é **vedada propaganda nos documentos clínicos** — este termo é autônomo. Observar também as restrições publicitárias do Código de Ética (Res. CFMV nº 1.138/2016), especialmente quanto à divulgação sensacionalista de casos.
...
```
TERMO DE GUARDA TEMPORÁRIA DE ANIMAL (DEPÓSITO)
...
> **Base legal:** Res. CFMV nº 1.236/2018 (define e caracteriza crueldade, abuso e maus-tratos); Res. CFMV nº 1.138/2016 (Código de Ética — dever de comunicar); art. 32 da Lei nº 9.605/1998, alterado pela Lei nº 14.064/2020. **Este documento não vai para o tutor** — destina-se à autoridade policial, Ministério Público ou órgão de fiscalização.

```
COMUNICAÇÃO DE SUSPEITA DE MAUS-TRATOS A ANIMAL
...
> Documento específico para o cirurgião itinerante. Delimita a responsabilidade quanto à estrutura do local, que não está sob controle do cirurgião.
...
______________________________________ CRMV nº ....................
```
...
```
NOTIFICAÇÃO EXTRAJUDICIAL — RETIRADA DE ANIMAL
...
## D9. Prontuário Médico-Veterinário — Estrutura Mínima

> **Base legal:** Res. CFMV nº 1.321/2020, atualizada pela Res. CFMV nº 1.653/2025. Deve ser preenchido **a cada atendimento**, independentemente do intervalo entre a saída e a nova admissão. É exceção à regra das duas vias.

**Campos obrigatórios a implementar no VetFlow:**

```
□ Identificação completa do estabelecimento e do médico-veterinário (nome, CRMV)
□ Identificação completa do responsável pelo animal
□ Identificação completa do paciente (incluindo microchip, quando houver)
□ Data e hora de cada atendimento
□ Relatos prestados pelo responsável pelo animal (anamnese)  ← ampliado pela 1.653/2025
□ Exame físico e parâmetros vitais
□ Diagnóstico ou hipóteses diagnósticas
□ Registro detalhado de TODOS os procedimentos realizados, com data, hora e
  identificação do profissional executor por NOME e número de CRMV  ← 1.653/2025
□ Prescrições, doses, vias e horários
□ Evolução diária em casos de internação ou tratamento prolongado
□ Cópias dos laudos de exames complementares, laboratoriais e de imagem  ← 1.653/2025
□ Todos os termos assinados, incluindo os de recusa
□ Registro de recusas de consentimento e de impossibilidade de obtê-lo
□ Registro de orientações prestadas ao responsável
□ Alta médica ou óbito

REGRAS DE SISTEMA
□ Entrega de cópia apenas ao responsável pelo animal, mediante solicitação
□ Prazo: 5 dias úteis, prorrogável até 30 dias mediante justificativa escrita
  apresentada pelo Responsável Técnico
□ Registro de toda entrega de cópia (data, meio, destinatário)
□ Vedado fornecer a terceiros sem autorização expressa
□ Imutabilidade e trilha de auditoria de todas as edições
□ Em caso de extravio: elaborar novo prontuário anotando a ocorrência, dar
  ciência ao responsável, registrar Boletim de Ocorrência se houver suspeita
  de crime e comunicar o CRMV
```

---

# 5. Matriz de emissão (para regras do VetFlow)

| # | Documento | Obrigatório pela Res. 1.321/2020 | Vias | Assinatura do responsável |
|---|---|---|---|---|
| A1 | Atestado de comparecimento | Não (art. 4º, §2º) | 2 | Não |
| A2 | Atestado de óbito | Sim | 2 | Não |
| A3 | Atestado sanitário / de saúde | Sim | **1** | Não |
| A4 | Atestado / carteira de vacinação | Sim | **1** (carteira) | Não |
| A5 | Relatório e encaminhamento | Não | 2 | Não |
| A6 | Solicitação de exame de imagem | Não (art. 4º, §2º) | 2 | Não |
| A7 | Solicitação laboratorial / anatomopatológico | Não (art. 4º, §2º) | 2 | Não |
| B1 | TCLE exames | **Sim** | 2 | **Sim** |
| B2 | TCLE procedimento cirúrgico | **Sim** | 2 | **Sim** |
| B2-C | TCLE consolidado anestésico-cirúrgico | Cobre III e VI | 2 | **Sim** |
| B3 | TCLE procedimentos anestésicos | **Sim** | 2 | **Sim** |
| B4 | TCLE procedimento terapêutico de risco | **Sim** | 2 | **Sim** |
| B5 | TCLE internação e tratamento | **Sim** | 2 | **Sim** |
| B6 | TCLE eutanásia | **Sim** | 2 | **Sim** |
| B7 | TCLE retirada de corpo em óbito | **Sim** | 2 | **Sim** |
| B8 | TCLE doação de corpo | **Sim** | 2 | **Sim** |
| B9 | Retirada sem alta médica | **Sim** | 2 | **Sim** (ou 2 testemunhas) |
| B10 | TCLE pesquisa clínica | **Sim** | 2 | **Sim** |
| C1 | Recusa de tratamento | Derivado do art. 10, II | 2 | **Sim** (ou 2 testemunhas) |
| C2 | Recusa de exames | Derivado do art. 10, II | 2 | **Sim** (ou 2 testemunhas) |
| C3 | Recusa de internação | Derivado do art. 10, II | 2 | **Sim** (ou 2 testemunhas) |
| C4 | Recusa de eutanásia indicada | Derivado do art. 10, II | 2 | **Sim** (ou 2 testemunhas) |
| C5 | Registro de recusa de assinatura | Derivado do art. 10, II | 2 | Testemunhas |
| D1 | Prognóstico e cuidados paliativos | Não | 2 | **Sim** |
| D2 | Orçamento | CDC art. 40 | 2 | **Sim** |
| D3 | Uso de imagem | CC art. 20 / LGPD | 2 | **Sim** |
| D4 | LGPD | LGPD | 2 | **Sim** |
| D5 | Guarda / hospedagem | Não | 2 | **Sim** |
| D6 | Comunicação de maus-tratos | Dever ético | 2+ | Não |
| D7 | Atendimento em ambiente externo | Não | 2 | **Sim** |
| D8 | Notificação de abandono | Não | 2 | Recibo |
| D9 | Prontuário | **Sim** | **1** | Não |

---

# 6. Sugestões de implementação no VetFlow

**Modelo de dados**
- Tabela `document_templates`: `id`, `codigo` (A1, B6…), `titulo`, `corpo_markdown`, `variaveis_requeridas[]`, `exige_assinatura_responsavel`, `numero_vias`, `base_legal`, `versao`, `ativo`, `created_at`.
- Tabela `documents`: `id`, `template_id`, `template_versao`, `atendimento_id`, `paciente_id`, `responsavel_id`, `vet_id`, `payload_json`, `pdf_url`, `hash_sha256`, `status` (rascunho/emitido/assinado/cancelado), `assinado_em`, `assinatura_metodo`, `assinatura_ip`, `emitido_em`.
- **Versionamento é essencial**: quando o modelo mudar, documentos já emitidos devem continuar referenciando a versão vigente à época.

**Regras de negócio**
- Bloquear agendamento de cirurgia sem TCLE cirúrgico e anestésico assinados.
- Bloquear registro de eutanásia sem TCLE de eutanásia + destinação do corpo definida.
- Ao registrar alta contra recomendação, disparar automaticamente o termo B9.
- Ao registrar recusa em qualquer ponto do fluxo, sugerir o termo C correspondente.
- Documento `emitido` é imutável: correções só por cancelamento com motivo + reemissão.
- Gerar hash SHA-256 do PDF e QR code de validação pública.
- Alerta de vencimento: atestado sanitário e orçamento com data de validade.

**Assinatura**
- Nível 1: impressão + assinatura física + upload do digitalizado.
- Nível 2: assinatura em tela (canvas) com captura de IP, timestamp e user-agent.
- Nível 3: integração ICP-Brasil ou provedor de assinatura eletrônica avançada.

---

# 7. Ressalva

Estes modelos foram elaborados a partir da legislação e das resoluções vigentes em agosto de 2026 e refletem a estrutura mínima exigida pela Resolução CFMV nº 1.321/2020, com as alterações da Resolução CFMV nº 1.653/2025. Não substituem análise jurídica individualizada.

**Recomendações antes de colocar em produção:**
1. Baixar os modelos oficiais disponibilizados pelo CFMV e pelos CRMVs e conferir campo a campo o conteúdo mínimo.
2. Submeter os termos a advogado com atuação em direito médico-veterinário ou direito do consumidor, especialmente quanto às cláusulas de isenção de responsabilidade — o CDC (art. 51, I) considera nula a cláusula que exonere o fornecedor de responsabilidade em relação consumerista. As declarações aqui redigidas têm valor primordialmente **probatório** do cumprimento do dever de informação, e não de exclusão automática de responsabilidade.
3. Verificar exigências adicionais do CRMV-SP e da legislação municipal de Campinas e Itapira.
4. Revisar a biblioteca anualmente, ou sempre que houver nova resolução do CFMV.
